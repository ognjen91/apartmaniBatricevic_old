...
<!--            ------u sustini je ostalo samo da ubacujem objekat, sobu i mjesec u $smjestajQuery ------------->
              ...
              <?php $smjestajQuery = "SELECT * FROM smjestaj WHERE (objekat = 'Kumbor' AND soba='Apartman2' AND mjesec='novembar')"; ?>
...
<!--            ------u sustini je ostalo samo da ubacujem objekat, sobu i mjesec u $smjestajQuery ------------->
              ...
              <?php $smjestajQuery = "SELECT * FROM smjestaj WHERE (objekat = 'Kumbor' AND soba='Apartman2' AND mjesec='decembar')"; ?>
...
<!--            ------u sustini je ostalo samo da ubacujem objekat, sobu i mjesec u $smjestajQuery ------------->
              ...
              <?php $smjestajQuery = "SELECT * FROM smjestaj WHERE (objekat = 'Kumbor' AND soba='Apartman2' AND mjesec='januar')"; ?>
