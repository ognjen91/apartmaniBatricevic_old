...
echo "<p class='aranzSaPopustom'>$k $day for $aranzmanKraci &#8364;<img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p>";
...
//        echo " ".$ukupanAranzmanKraciPreskok;
       ...
       if ($k == $brojacDoZauzetogUkupno - 2){
           ...
           echo "<p>$dana days for $ponudaMinus2  &#8364; <img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p> ";
       }
        if ($k == $brojacDoZauzetogUkupno - 3){
           $ponudaMinus1 = $ukupanAranzmanKraciPreskok;
            $dana = $k+1;
            include "kombiPonudaKracePreskok.php";
            echo "<p>$dana days for $ponudaMinus1  &#8364; <img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p> ";
       }
       $k++;
...
//        echo " ".$ukupanAranzmanKraciPreskok;
       ...
       if ($k == $brojacDoZauzetogUkupno - 2){
           ...
           $dana = $k+1;
           include "kombiPonudaKracePreskok.php";
           echo "<p class='aranzSaPopustom'>$dana days for $ponudaMinus2 &#8364; <img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p> ";
       }
        if ($k == $brojacDoZauzetogUkupno - 3){
           $ponudaMinus1 = $ukupanAranzmanKraciPreskok;
            $dana = $k+1;
            include "kombiPonudaKracePreskok.php";
            echo "<p class='aranzSaPopustom'>$dana days for $ponudaMinus1 &#8364; <img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p> ";
       }
       $k++;
...
//    echo ' '. $parcijalneSume[$danaIzSljedecegMjeseca];
    ...
    include "kombinacijeKonacnaPonudaKrace.php";
     ...
     echo "<p class='aranzSaPopustom'>$brojacDoZauzetogUkupno days for $ukupanAranzmanKraciPreskok &#8364; <img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p>";
}
