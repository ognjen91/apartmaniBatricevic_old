...
echo "<p class='aranzSaPopustom'>$k $day for $dioPonudeIzAktivnog &#8364;<img src='" . get_template_directory_uri() . "/Kalendar/exclamation.png' alt='uzvicnik' class='uzvicnik'><span class='vrijednostPopusta'> - $popust%</span></p>";    
